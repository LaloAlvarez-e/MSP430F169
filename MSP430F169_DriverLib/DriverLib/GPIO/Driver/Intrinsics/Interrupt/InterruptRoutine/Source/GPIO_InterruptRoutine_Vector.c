...
__interrupt void PORT1_IRQVectorHandler(void)
{
    ...
    if(0U != (u8Flags & PORT_IFG_R_PIN0_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER0);
    }
    if(0U != (u8Flags & PORT_IFG_R_PIN1_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER1);
    }
    if(0U != (u8Flags & PORT_IFG_R_PIN2_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER2);
    }
    if(0U != (u8Flags & PORT_IFG_R_PIN3_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER3);
    }
    if(0U != (u8Flags & PORT_IFG_R_PIN4_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER4);
    }
    if(0U != (u8Flags & PORT_IFG_R_PIN5_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER5);
    }
    if(0U != (u8Flags & PORT_IFG_R_PIN6_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER6);
    }
    if(0U != (u8Flags & PORT_IFG_R_PIN7_MASK))
    {
        ...
        u16Status &= IRQSourceHandlerReg(PORT1_BASE, (uint16_t) GPIO_enPIN_NUMBER7);
    }
    if(0xFFU != u16Status)
    {
