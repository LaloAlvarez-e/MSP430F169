 ...
 */
#include <DriverLib/DMA/Driver/Channel/Config/Header/DMA_DataSize.h>
                          ...
                          DMA_nCH_DATASIZE enSizeArg)
{
    ...
    pstRegisterData.u16Mask = DMA_CH_CTL_SRCBYTE_MASK;
    pstRegisterData.u8Shift = DMA_CH_CTL_R_SRCBYTE_BIT;
                          ...
                          DMA_nCH_DATASIZE enSizeArg)
{
    ...
    pstRegisterData.uptrAddress = DMA_CH_CTL_OFFSET;
    pstRegisterData.u16Value = (uint16_t) enSizeArg;
    pstRegisterData.u16Mask = DMA_CH_CTL_DSTBYTE_MASK;
    pstRegisterData.u8Shift = DMA_CH_CTL_R_DSTBYTE_BIT;
    DMA_CH__vWriteRegister(enChannelArg,
                         &pstRegisterData);
}
