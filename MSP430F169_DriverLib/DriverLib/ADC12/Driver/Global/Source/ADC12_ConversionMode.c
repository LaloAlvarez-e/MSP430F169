...
void ADC12__vSetConversionMode(ADC12_nMODE enModeArg)
{
    ...
    pstRegisterData.u16Mask = ADC12_CTL1_CONSEQ_MASK;
    pstRegisterData.u8Shift = ADC12_CTL1_R_CONSEQ_BIT;
...
ADC12_nMODE ADC12__enGetConversionMode(void)
{
    ADC12_Register16Bits_t pstRegisterData;
    pstRegisterData.uptrAddress = ADC12_CTL1_OFFSET;
    pstRegisterData.u16Value = (uint16_t) ADC12_enMODE_SINGLE;
    pstRegisterData.u16Mask = ADC12_CTL1_CONSEQ_MASK;
    pstRegisterData.u8Shift = ADC12_CTL1_R_CONSEQ_BIT;
    (void) ADC12__u16ReadRegister(&pstRegisterData);
    return ((ADC12_nMODE) pstRegisterData.u16Value);
}
