                         ...
                         uint16_t u16AddressArg)
{
    ...
    pstRegisterData.uptrAddress = ADC12_CH_SA_OFFSET;
    pstRegisterData.u16Value = (uint16_t) u16AddressArg;
    pstRegisterData.u16Mask = ADC12_CH_SA_SA_MASK;
    pstRegisterData.u8Shift = ADC12_CH_SA_R_SA_BIT;
