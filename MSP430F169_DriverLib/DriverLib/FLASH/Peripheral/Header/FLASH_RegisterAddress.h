...
#define FLASH_MAIN_END_ADDRESS (FLASH_MAIN_START_ADDRESS + FLASH_MAIN_SIZE - 1U)
#define FLASH_INFO_END_ADDRESS (FLASH_INFO_START_ADDRESS + FLASH_INFO_SIZE - 1U)

#define FLASH_MAIN_BLOCK_NUMBER_BY_SEGMENT ((FLASH_MAIN_SEGMENT_SIZE - 1U) / FLASH_BLOCK_SIZE)
#define FLASH_INFO_BLOCK_NUMBER_BY_SEGMENT ((FLASH_INFO_SEGMENT_SIZE - 1U) / FLASH_BLOCK_SIZE)

#define FLASH_MAIN_SEGMENT_NUMBER (((FLASH_MAIN_SIZE - 1U) / FLASH_MAIN_SEGMENT_SIZE) + 1U)
#define FLASH_INFO_SEGMENT_NUMBER (((FLASH_INFO_SIZE - 1U) / FLASH_INFO_SEGMENT_SIZE) + 1U)
