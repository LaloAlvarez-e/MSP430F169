...
#ifndef DRIVERLIB_TIMERB_DRIVER_GLOBAL_HEADER_TIMERB_GROUPLOAD_H_
#define DRIVERLIB_TIMERB_DRIVER_GLOBAL_HEADER_TIMERB_GROUPLOAD_H_
...
#endif /* DRIVERLIB_TIMERB_DRIVER_GLOBAL_HEADER_TIMERB_GROUPLOAD_H_ */
