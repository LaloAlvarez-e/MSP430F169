/**
 *
 * @file TIMERB_CaptureInputState.h
 * @copyright
...
#ifndef DRIVERLIB_TIMERB_DRIVER_MODULE_HEADER_TIMERB_CAPTUREINPUTSTATE_H_
#define DRIVERLIB_TIMERB_DRIVER_MODULE_HEADER_TIMERB_CAPTUREINPUTSTATE_H_
