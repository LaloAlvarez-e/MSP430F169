...
#ifndef DRIVERLIB_TIMERA_DRIVER_MODULE_HEADER_TIMERA_MODULEMODE_H_
#define DRIVERLIB_TIMERA_DRIVER_MODULE_HEADER_TIMERA_MODULEMODE_H_
...
#endif /* DRIVERLIB_TIMERA_DRIVER_MODULE_HEADER_TIMERA_MODULEMODE_H_ */
