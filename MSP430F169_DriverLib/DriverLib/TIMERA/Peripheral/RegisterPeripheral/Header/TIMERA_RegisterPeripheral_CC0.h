/**
 *
 * @file TIMERA_RegisterPeripheral_CC0.h
 * @copyright
...
#define TIMERA_CC0 ((TIMERA_CC_t*) TIMERA_CC0_BASE)

/******************************************************************************************
 ************************************ 1 CTL *********************************************
 ******************************************************************************************/
#define TIMERA_CC0_CTL_R  (*(volatile uint16_t*) (TIMERA_CC0_BASE + TIMERA_CC_CTL_OFFSET))
#define TIMERA_CC0_CTL    ((TIMERA_CC_CTL_t*) (TIMERA_CC0_BASE + TIMERA_CC_CTL_OFFSET))

/******************************************************************************************
 ************************************ 2 R *********************************************
 ******************************************************************************************/
#define TIMERA_CC0_R_R (*(volatile uint16_t*) (TIMERA_CC0_BASE + TIMERA_CC_R_OFFSET))
#define TIMERA_CC0_R ((TIMERA_CC_R_t*) (TIMERA_CC0_BASE + TIMERA_CC_R_OFFSET))
