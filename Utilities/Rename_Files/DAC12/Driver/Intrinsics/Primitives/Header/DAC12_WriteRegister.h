...
void DAC12__vWriteRegister(DAC12_Register16Bits_t* pstRegisterData);
void DAC12_CH__vWriteRegister_16bits(DAC12_nCH enChannelArg,
                            DAC12_Register16Bits_t* pstRegisterData);
void DAC12_CH__vWriteRegister_8bits(DAC12_nCH enChannelArg,
