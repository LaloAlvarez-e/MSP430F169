...
void MAIN_vADCInit(void)
{
    ...
    ADC12_CH__vRegisterIRQSourceHandler(ADC12_enCH1, &MAIN_u16ADCConversionComplete);
...
uint16_t MAIN_u16ADCConversionComplete(uintptr_t uptrBlock, uint16_t u16Conversion)
{
    ...
    {
    case ADC12_CH0_BASE :
        u16LDRValue = u16Conversion;
        ADC12->CTL0_bits.SC = 0U;
        ADC12->CTL0_bits.SC = 1U;
        break;
    case ADC12_CH1_BASE :
        u16POTValue = u16Conversion;
        ADC12->CTL0_bits.SC = 0U;
        ADC12->CTL0_bits.SC = 1U;
        break;
    case ADC12_CH2_BASE :
