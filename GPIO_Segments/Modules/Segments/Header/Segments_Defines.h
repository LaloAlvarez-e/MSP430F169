...
#define SEGMENTS_DIGIT1_PIN (GPIO_enPIN_NUMBER3)
#define SEGMENTS_DIGIT2_PIN (GPIO_enPIN_NUMBER2)
#define SEGMENTS_DIGIT3_PIN (GPIO_enPIN_NUMBER1)
#define SEGMENTS_DIGIT4_PIN (GPIO_enPIN_NUMBER0)
