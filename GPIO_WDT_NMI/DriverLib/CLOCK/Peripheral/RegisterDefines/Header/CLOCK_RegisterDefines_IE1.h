...
#define CLOCK_IE1_R_OFIE_MASK (CLOCK_IE1_IE_MASK<< CLOCK_IE1_R_IE_BIT)
#define CLOCK_IE1_R_OFIE_DIS (CLOCK_IE1_OFIE_DIS << CLOCK_IE1_R_IE_BIT)
#define CLOCK_IE1_R_OFIE_ENA (CLOCK_IE1_OFIE_ENA << CLOCK_IE1_R_IE_BIT)
/*-----------*/
