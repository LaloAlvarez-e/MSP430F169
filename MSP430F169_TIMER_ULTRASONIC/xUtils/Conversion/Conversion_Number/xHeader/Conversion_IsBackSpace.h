 ...
 */
#ifndef XUTILS_CONVERSION_XHEADER_CONVERSION_NUMBER_CONVERSION_ISBACKSPACE_H_
#define XUTILS_CONVERSION_XHEADER_CONVERSION_NUMBER_CONVERSION_ISBACKSPACE_H_
