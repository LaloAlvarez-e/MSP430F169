 ...
 */
#ifndef XUTILS_CONVERSION_XHEADER_CONVERSION_NUMBER_CONVERSION_ISRETURN_H_
#define XUTILS_CONVERSION_XHEADER_CONVERSION_NUMBER_CONVERSION_ISRETURN_H_
